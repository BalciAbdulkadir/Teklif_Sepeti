...
namespace Teklif_Sepeti.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        // Kullanıcının mevcut e-posta adresi
        ...
        // Form verilerini bağlamak için kullanılan model
        [BindProperty]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Lütfen yeni e-posta adresinizi onaylamak için <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>buraya tıklayın</a>.");

                StatusMessage = "E-posta değişikliği için onay bağlantısı gönderildi. Lütfen e-postanızı kontrol edin.";
